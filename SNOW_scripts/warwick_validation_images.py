...
clfs = ['GEN-r50-datacentered', 'GSN-r50-datacentered']
...
for clf_name in clfs:
	...
	params = {
		...
		"dataset_dir": "e:/data/annotations tmas/Warwick QU Dataset (Released 2016_07_08)",
		"annotations": "anno"
	}
	...
	for ds in ['testA', 'testB']:
		...
		plt.imshow(overlay)
		plt.axis('off')
		plt.savefig("E:/pCloud/ULB/Doctorat/Rapports/WeakSupervision/Warwick/images_warwick/%s-%d-%s.png"%(ds,idx,clf_name))